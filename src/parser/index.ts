...
export class Parser {
    ...
    getFieldWrapperComponent(field: Field): VueComponent {
        ...
        if (field.props.hidden === true) defaultWrapper = "div"
    ...
    getFieldWrapperComponentProps(field: Field): VueComponentProps {
        ...
        if (field.propsWrapper) return field.propsWrapper
        ...
        if (!field.props.hidden && field.label !== "none") {
            ...
            if (field.label) props.label = field.label
            else if (field.name) props.label = toTitleCase(field.name)
        }

        if (field.type === "checkbox") props.class = "vfb-group-checkbox"
    ...
    parseField(field: FieldDescription): Field {
        ...
        if (typeof field === "string") field = this.stringToField(field)
        else field = deepCopy(field)
